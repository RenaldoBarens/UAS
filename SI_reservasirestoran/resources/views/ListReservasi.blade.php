...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">List Reservasi Open</div>
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/Reservasi') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                                ...
                                <tbody>
                                    ...
                                    @foreach($reservasi as $item)                                            
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('/Reservasi/' . $item->id) }}" title="View RestoranPelanggan"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Detail </button></a>
